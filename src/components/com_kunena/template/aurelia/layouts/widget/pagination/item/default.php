...
if ($item->base !== null)
{
	...
	echo '<li class="page-item">
			<a class="page-link" ' . \Joomla\Component\Kunena\Libraries\Template\Template::getInstance()->tooltips(true) . ' href="' . $item->link . '" title="' . Text::_('COM_KUNENA_PAGE') . $item->text . '">' . $item->text . '</a>
		  </li>';
}
