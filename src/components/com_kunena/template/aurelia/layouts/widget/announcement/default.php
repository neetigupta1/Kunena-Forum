...
<div class="shadow-lg rounded" id="announcement<?php echo $this->announcement->id; ?>">
	<div class="alert alert-info">
		...
		<h5>
			<a class="btn-link"
			   href="<?php echo \Joomla\Component\Kunena\Libraries\Route\KunenaRoute::_('index.php?option=com_kunena&view=announcement&layout=list'); ?>"
		...
		<?php if (!empty($this->announcement->description))
			...
			<div>
				<a class="btn-link"
				   href="<?php echo \Joomla\Component\Kunena\Libraries\Route\KunenaRoute::_('index.php?option=com_kunena&view=announcement&layout=default&id=' . $this->announcement->id); ?>"
