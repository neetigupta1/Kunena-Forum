 ...
 * @since 2.0
 */
class KunenaAdminModelCategories extends Model
{
	/**
	 * @var     string
	 * @since   Kunena 6.0
	...
	/**
	 * @return  boolean|\Kunena\Forum\Libraries\Forum\Category\Category|void
	 *
	 * @since   Kunena 6.0
	 *
	 * @throws  \Exception
	...
	/**
	 * @return  array|\Kunena\Forum\Libraries\Forum\Category\Category[]
	 *
	 * @since   Kunena 6.0
	 *
	 * @throws  null
